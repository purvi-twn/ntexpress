				...
				<div class="alert alert-danger" id="error_message" style="display:none;"></div>
						<div class="row">
							<div class="col-6 text-left">
								<h3> All Credit Notes</h3>
							</div>
							<div class="col-6 text-right">
								<button class="btn btn-danger" onclick="location.href='<?php echo $site_url; ?>creadit-notes-add'"> <i class="fa fa-plus"></i> New </button>
							</div>
                       	</div>
				</div>
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                                $no=1;
                                $row=select_query("*","credit_note", "", "id desc");
                                if($row->num_rows)
                                {
                            ...
                            ?>      
                                        <tr>
                                            ...
                                            <td><?php echo $b['credit_note']; ?></td>
                                            <td><?php echo $b['reference']; ?></td>
                                            <td><?php echo $b['total']; ?></td>
                                            <td></td>
                                            <td>
                                                <a href="<?php echo $site_url; ?>creadit-notes-edit/<?php echo $b['id'] ?>"><i class="far fa-edit"></i></a>
