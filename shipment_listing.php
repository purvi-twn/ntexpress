						   ...
						   $total_fc=0;
							  ...
							  if($row->num_rows)
							  {
								  while($b=$row->fetch_array())
								  {
									  ...
									  if($b['aid']!=0)
									  {
										  $sagent=fetch_query("name,agent_no","agent",array("id="=>$b['sender_agentid']));
										  $aid=$sagent['name']."(".$sagent['agent_no'].")";
									  }
									  else
									  	$aid='Admin';
									  ...
									  $dagent=fetch_query("name,agent_no","agent",array("id="=>$b['desti_agentid']));
									 $status=$b['status'];
								?>
                            <tr>
                                <td><?php echo $no; ?></td>
                                ...
                                <td><a href="<?php echo $site_url; ?>shipment-add/<?php echo $b['id'] ?>"><i class="far fa-edit"></i></a>
                                      ...
                                      <div class="modal-body">
                                      	<div class="row">
											<div class="col-lg-12">
                                                ...
                                                <div class="row">
													<div class="col-lg-6 col-md-6 col-sm-12 col-12">Agent</div>
                                                ...
                                                <div class="row">
													<div class="col-lg-6 col-md-6 col-sm-12 col-12">Agent</div>
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12"><?php echo $dagent['name']."(".$dagent['name'].")"; ?></div>
                                                </div>
                                                <div class="row">
													<div class="col-lg-6 col-md-6 col-sm-12 col-12">State</div>
