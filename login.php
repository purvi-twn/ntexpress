...
<!--<body style="background-color: black" data-overlay="4" cz-shortcut-listen="true">-->
        ...
        <div class="row align-items-center justify-content-md-center h-p100">
            <div class="col-lg-5 col-md-8 col-12">
                ...
                <div class="bg-white content-bottom">
                    ...
                    <a href="/billing/staff-login" class="btn btn-danger btn-block margin-top-10">Employee Login</a>
                </div>
            </div>
        </div>
    </div>
...
{
	$sel=$dlink->query("select username from myadmin where username='".$_POST['username']."' and password='".$_POST['password']."'");
	if($sel->num_rows>=1)
	{
		$res=$sel->fetch_array();
		$_SESSION['ntexpress_retroadm']=$res['username'];
		?>
	...
	else
	{
		...
		<script>window.location="<?php echo $site_url?>index";</script><?php
		exit;
	}
}
