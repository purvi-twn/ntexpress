...
else   
{
	...
	$status=1;
	$barcode_image="";
	$consignment_no=date('ymdis').rand(1,9);
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form method="post" action="" name="bg" id="bg" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-12" style="float:right">
                                <!--create barcode-->
								Barcode: 
								<?php 
                                if(@$_GET['id']=='')
                              ...
                              <div class="row"> 
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                <h5>Sender Deptartment<span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <select name="sender_deptid" id="sender_deptid" class="form-control" onchange="display_agent(this.value,'sender_agentid')">
                                         ...
                                         <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                             <div class="form-group">
                                                <h5>Sender Agent <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <select name="sender_agentid" id="sender_agentid" class="form-control" onchange="display_salary(this.value)">
                                   	...
                                   	<div class="row"> 
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="sender_mobile" id="sender_mobile" class="form-control" value="<?php echo $sender_mobile; ?>" onkeypress="return isNumberKey(event);" autocomplete="off">
                                                     <div id="suggesstion-box-sender-mobile"></div> 
                                                </div>
                                            </div>
                                        </div>
                                   	</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                <h5>Sender Province<span class="text-danger">*</span></h5>
                                                <div class="controls">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                <h5>Sender City</h5>
                                                <div class="controls"> 
                                                <select name="source_city" id="source_city" class="form-control">
                                                    ...
                                                    {
                                                        $selcit=mysqli_query($dlink,"select s.name as state_name, c.* from  location s LEFT JOIN location c ON s.location_id=c.parent_id where s.parent_id='184'and c.location_type='2' order by c.name");				while($s1=mysqli_fetch_array($selcit)) 
                                                        {
                                                            ?>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                        	<div class="form-group">
                                                <h5>Sender Id</h5>
                                                <div class="controls">
                                                    <input type="text" name="sender_id" id="sender_id" class="form-control" value="<?php echo $sender_id; ?>" autocomplete="off">
                                                    <div id="suggesstion-box-sender"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                        	<div class="form-group">
                                                <h5>Sender Land Mark</h5>
                                                <div class="controls">
                                                    <input type="text" name="sender_landmark" id="sender_landmark" class="form-control" value="<?php echo $sender_landmark; ?>" autocomplete="off">
                                                    <div id="suggesstion-box-sender"></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="row"> 
                                     		<div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                        		<div class="form-group">
                                            		<h5>Receiver Deptartment<span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                             ...
                                             <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group"> 
                                                    <h5>Receiver Agent <?php //echo $sender_agentid?><span class="text-danger">*</span></h5>
                                                        <div class="controls">
                                                           <select name="desti_agentid" id="desti_agentid" class="form-control" onchange="display_salary(this.value)">
                                                                ...
                                                                {
                                                                ?>
                                                                <option <?php if($dp['id']==$desti_agentid){ ?> selected <?php } ?> value="<?php echo $dp['id']; ?>"><?php echo $dp['name']."-".$dp['agent_no']; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <h5>Receiver Province<span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="destination_city" id="destination_city" class="form-control">
                                                            ...
                                                            {
                                                                $selcit=mysqli_query($dlink,"select s.name as state_name, c.* from  location s LEFT JOIN location c ON s.location_id=c.parent_id where s.parent_id='184'and c.location_type='2' order by c.name");
                                                                while($s1=mysqli_fetch_array($selcit)) {
                                                                ?>
                                                                <option value="<?php echo $s1['location_id']; ?>" ><?php echo $s1['name']; ?></option>
                                                                <?php
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            	<div class="form-group">
                                                    <h5>Receiver Id</h5>
                                                    <div class="controls">
                                                        <input type="text" name="desti_id" id="desti_id" class="form-control" value="<?php echo $desti_id; ?>" autocomplete="off">
                                                        <div id="suggesstion-box-sender"></div>
                                                    </div>
                                                </div>
                                            </div>
...
<a data-toggle="modal" data-target="#myModal" style="display:none" id="add_cust">add customer</a>
<!-- Modal -->
	...
	<div class="modal-dialog">
		<div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add New Customer Details</h4>
            </div>
            <div class="modal-body">
            <form name="frmnewcusto" id="frmnewcusto" action="" method="post"> 
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control" name="zipcode" id="zipcode" placeholder="Enter Zipcode Number"  onkeypress="return isNumberKey(event)" />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<select name="state" id="state" class="form-control" onchange="get_city(this.value,'city')">
			...
			<div class="modal-body">
                ...
                <div class="form-group">
					<label class="control-label">Email-Id</label>
					<input type="email" name="rcvr_email" id="rcvr_email" value="<?php echo $rcvr_email; ?>" class="form-control">		<p id="userexist" style="color:#F00;"></p>					
              	</div>
                <div class="form-group">
					<label class="control-label">Mobile Number*</label>
                ...
                <div class="form-group">
					<label class="control-label">Zipcde</label>
				...
				<div class="form-group">
					<label class="control-label">State</label>
					<select name="rcvr_state" id="rcvr_state" class="form-control" onchange="get_rcvr_city(this.value,'rcvr_city')"> 
                                                        <option value="">Select State</option>
                                                        <?php
                                                        $selsta=mysqli_query($dlink,"SELECT * FROM location where location_type='1' and parent_id='".$country."' and is_visible='0' order by name");
                                                        while($s=mysqli_fetch_array($selsta)) {
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" id="custosave" name="custosave" onclick="submit_new_customer()">Save</button>
            </div>
    	</div>
	</div>
</div>
...
$(document).ready(function(){ 
	...
	{ 
		...
		if($("#source_state").val()=="")
		{
			$("#source_state").attr("placeholder", "Please Select Source Country.");
		...
		{
			$("#destination_state").attr("placeholder", "Please Select Destination Country.");
...
function get_rcvr_city(val)
{
	$.ajax({
	 ...
	 {	
	 	if(data.trim()=='Not Found')
		{
			$("#rcvr_city").html('<option value="">Select</option>');  
		}
		else if(data.trim()=='blank')
		{
			$("#rcvr_city").html('<option value="">Select</option>');  
...
if(isset($_POST['submit'])!='')
{
  ...
  {  
	  ...
	  $delivery_date=$delivery_date." ".$delivery_time;
	  $pickup_date=$pickup_date." ".$pickup_time;
	  $arr=array("consignment_no"=>$_POST['consignment_no'],"invoice_number"=>$_POST['invoice_number'],"invoice_date"=>date('Y-m-d',strtotime($_POST['invoice_date'])),"source_country"=>$_POST['source_country'],"source_state"=>$_POST['source_state'],"source_city"=>$_POST['source_city'],"destination_country"=>$_POST['destination_country'],"destination_state"=>$_POST['destination_state'],"destination_city"=>$_POST['destination_city'],"no_of_package"=>$_POST['no_of_package'],"amount"=>$_POST['amount'],"tax_percentage"=>$_POST['tax_percentage'],"total_amount"=>$_POST['total_amount'],"payment_cash"=>$_POST['total_case'],"payment_fc"=>$_POST['total_fc'],"destination_address"=>$_POST['destination_address'],"source_address"=>$_POST['source_address'],"comment"=>$_POST['comment'],"sender_deptid"=>$_POST['sender_deptid'],"sender_agentid"=>$_POST['sender_agentid'],"desti_deptid"=>$_POST['desti_deptid'],"desti_agentid"=>$_POST['desti_agentid'],"sender_name"=>$_POST['sender_name'],"sender_mobile"=>$_POST['sender_mobile'],"desti_name"=>$_POST['desti_name'],"desti_mobile"=>$_POST['desti_mobile'],"sender_email"=>$_POST['sender_email'],"desti_email"=>$_POST['desti_email'],"type_of_product"=>$_POST['type_of_product'],"mode"=>$_POST['mode'],"delivery_date"=>$delivery_date,"pickup_date"=>$pickup_date,"status"=>$_POST['status'],"added_on"=>$dt,"barcode_image"=>$_POST['barcode_image'],"sender_id"=>$_POST['sender_id'],"sender_landmark"=>$_POST['sender_landmark'],"desti_id"=>$_POST['desti_id'],"desti_landmark"=>$_POST['desti_landmark']);
	...
	$content = $lpdf->Output('_private_content_shipment/l_'.$last_id.'.pdf','F');
	  ...
	  header("location:".$site_url."shipment-preview/".$last_id);
	 // header("location:".$site_url."shipment-listing");
	  exit;
  }
}
?>
