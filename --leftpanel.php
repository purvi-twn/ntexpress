    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
			...
			{ ?>
                ...
                <?php 
                if(@$_SESSION['ntexpress_retrosales']!='' || @$_SESSION['ntexpress_retroadm']!='')
                { ?>
                <li <?php if($page2=='customer-listing' || $page2=='invoice' || $page2=='new-shipment') { ?> class="treeview active" <?php } else { ?> class="treeview" <?php }?> >
                    ...
                    <ul class="treeview-menu">
                         ...
                         <li <?php if($page2=='customer-listing') { ?> class="active" <?php } ?>>
                            ...
                            <li>
                                <a href="<?php echo $site_url; ?>creadit-notes-listing"><i class="fa fa-user mr-5"></i><span class="font1">Credit Notes</span> </a>
                            </li>
