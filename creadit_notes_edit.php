                                    ...
                                    if(@$_REQUEST['id']!='')
                                    {
                                        ...
                                        { 
                                            ...
                                            { ?>
                                                ...
                                                <tr class="tr_<?php echo $i; ?>" id="<?php echo $i; ?>">
                                                    <!-- <td>
                                                    ...
                                                    <td>
                                                        <i class="fas fa-trash-alt newicon" id="<?php echo $i;?>" onclick="hidetr(this.id);"></i>
                                                        <input type="hidden" id="trremove_<?php echo $i;?>" value="1" name="trremove_<?php echo $i;?>" />
...
$('.add-comp').on("click", function(e){
    ...
    var new_input = '<tr class="tr_'+no+'" id="'+no+'">'+
    '<input type="text" name="trdata[]" value="0" class="trdata_'+ci+'">'+'<td>'+no+'</td><td><input type="text" name="type_of_product['+ci+']" id="type_of_product'+ci+'" class="form-control" value=""></td><td><input type="text" name="quantity['+ci+']" id="quantity'+no+'" class="form-control" value="" onkeypress="return isNumberKey(event);" onblur="get_calulation('+no+')"></td><td><input type="text" name="price['+ci+']" id="price'+no+'" class="form-control" value="" onkeypress="return isNumberKey(event);" onblur="get_calulation('+no+')"></td><td><input type="text" name="discount['+ci+']" id="discount'+no+'" class="form-control" value="" onkeypress="return isNumberKey(event);" onblur="get_calulation('+no+')"></td><td class="taxval taxHideShow" style="display:'+dspval+';">'+tax+'</td><td><input type="text" name="amount['+ci+']" id="amount'+no+'" class="form-control" value="" onkeypress="return isNumberKey(event);" readonly="readonly"></td><td><i class="fas fa-trash-alt newicon" id="'+no+'" onclick="hidetr(this.id);"></i><input type="hidden" id="trremove_'+no+'" value="1" name="trremove_'+no+'" /></td></tr>';
...
function find_sub_total()
{
    ...
    var u_row=$('#update_rows').val();
    var t_row=$('#total_rows').val();
    var total_insert_row = t_row-1;

    var fid = u_row + total_insert_row;
