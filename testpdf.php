     ...
     <h1>&nbsp;</h1>
		  ...
		  <div class="row" >
			...
			else
			{
				...
				//}
			$html.='</div>
			<div class="col-md-6" align="right" style="padding-left:70px;width:20%;display:inline-block;margin-botton:1%;padding-top:50px">Consignment No.: '.$qrget['consignment_no'].'</div>
		...
		<div class="row">
			<div class="col-md-5" style="border:1px solid gray;padding:3px 10px;background-color:#f4f3f2;width:44%;display:inline-block;">
				<table style="width:100%;">
					<tr><td style="width:25%;font-weight:bold"><img src="Invoice_Png_Files/Invoice Number.png" width="160"></td><td style="width:80%;font-weight:bold;font-size:15px !important" align="right">'.$shipment['invoice_number'].'</td></tr>
				</table>
			</div>
			...
			<div class="col-md-5" style="border:1px solid gray;padding:3px 10px;background-color:#f4f3f2;width:44%;display:inline-block;float:right">
				<table style="width:100%">
					<tr><td style="width:25%;font-weight:bold"><img src="Invoice_Png_Files/Invoice Date.png" width="160"></td><td style="width:80%;font-weight:bold;font-size:15px !important" align="right">'.$shipment['invoice_date'].' 03:05:00'.'</td></tr>
				</table>
			</div>
		</div>
		...
		<div class="row" style="margin-top:2px">
			<div class="col-md-5" style="border:1px solid gray;background-color:#f4f3f2;width:46.5%;display:inline-block;color:#000000;padding-right:0px !important;padding-left:0px !important">
				<table class="table"> 
						...
						<tr>
							<td><img src="Invoice_Png_Files/name.png" width="141"></td>
							<td style="color:#6c6c6c;font-size:12px !important">'.$shipment['sender_name'].'
							</td>
						</tr>
						<tr>
							<td><img src="Invoice_Png_Files/address.png" width="141"></td>
						...
						<tr>
							<td><img src="Invoice_Png_Files/cont-no.png" width="141"></td>
							<td style="color:#6c6c6c;font-size:12px !important">'.$shipment['sender_mobile'].'</td>
						</tr>
						<tr>
							<td><img src="Invoice_Png_Files/city.png" width="141"></td>
							<td style="color:#6c6c6c;font-size:12px !important">'.$city['name'].'</td>
						</tr>
						<tr>
							<td><img src="Invoice_Png_Files/country.png" width="141"></td>
							<td>Saudi Arabia</td>
						</tr>';
						$html.='<tr>
								<td><img src="Invoice_Png_Files/vat.no.png" width="141"></td>
