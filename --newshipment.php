                   ...
                   <div class="grybox mb-20">
                       <div class="row mb-20 sp-4">
                        ...
                        <div class="row mb-20 sp-4">
							...
							{ ?>
                                <input class="form-control" type="text" name="sales_person" value="<?php echo $staff_person; ?>"><?php
							}?>
                            </div>
                        </div>
                   </div>
	                        ...
	                        <div class="col-md-6 box-sender-1">
	                            <div class="grybox mb-20">
	                                ...
	                                <div class="row mt-20">
	                                    ...
	                                    <div class="col-sm-12 col-md-3 controls"> 
	                                        <input type="email" name="sender_email" id="sender_email" class="form-control" value="<?php echo $email; ?>" onblur="emailchk(this.value)">
	                                    </div>
	                                </div>
	                                <div class="row mt-20">
                                    ...
                                    <div class="row mt-10 mb-10">
	                                    ...
	                                    <div class="col-sm-12 col-md-9 controls">
	                                    	<input type="text" name="customerid" id="customerid" class="form-control" value="" onkeypress="return isNumberKey(event);" autocomplete="off" maxlength="10" onblur="iqamawidth(this.value)">
	                                    </div>
                                        
                                    </div>
									<div class="row mt-20" id="vat">
	                                    <div class="col-sm-12 col-md-3 controls">
	                                        <label><span>Tax Registration No.</span></label>
	                                    </div>
	                                    <div class="col-sm-12 col-md-9 controls">
	                                    	<input type="text" name="taxnumber" id="taxnumber1" class="form-control" value="" minlength="15" maxlength="15" onblur="checkwidth(this.value)">
	                                    </div>
	                                </div>
	                            </div>
	                        </div>
	                            ...
	                            <div class="grybox">
	                               ...
	                               <div class="row mt-20">
	                                ...
	                                <div class="row mt-20">
	                                    ...
	                                    <div class="col-sm-12 col-md-3 controls"> 
	                                        <input type="email" name="desti_email" id="desti_email" class="form-control" value="<?php echo $desti_email; ?>" onblur="emailchk(this.value)">
	                                    </div>
	                                ...
	                                <div class="row mt-20">
	                                    ...
	                                    <div class="col-sm-12 col-md-3 controls">
	                                       <input type="text" name="desti_iqamano" id="desti_iqamano" class="form-control" value="<?php echo $rcvr_iqamano; ?>" onkeypress="return isNumberKey(event);" autocomplete="off" maxlength="10" onblur="iqamawidth(this.value)">
	                                       <div id="suggesstion-box-sender"></div>
	                                    </div><div class="col-sm-12 col-md-3 controls">
	                                        <label><span>VAT No.</span></label>
	                                    </div>
	                                    <div class="col-sm-12 col-md-3 controls"> 
	                                        <input type="text" name="desti_vat_no" id="desti_vat_no" class="form-control" value="<?php echo $rcvr_vat_no; ?>" minlength="15" maxlength="15"onblur="checkwidth(this.value)">
	                                    </div>
		                            ...
		                            <div class="row mb-133">
	                                    ...
	                                    <div class="col-sm-12 col-md-9 controls">
	                                    	<div class="demo-radio-button">
		                                        <input name="customer_type" type="radio" id="business" class="with-gap radio-col-maroon" value="1" checked>
		                                        <label for="business">Business</label>
		                                        <input name="customer_type" type="radio" id="individual" class="with-gap radio-col-maroon"  value="2">
			                                	...
			                                	<tr class="tr_0">
			                                        ...
			                                        <select name="type_of_product[0]" id="type_of_product[0]" class="form-control">
			                                            	...
			                                            	<option <?php if ('Document' == $b['type_of_product']) {?> selected="selected" <?php }?> value="Document">Document</option>
			                                              	<option <?php if ('Electronics' == $b['type_of_product']) {?> selected="selected" <?php }?>  value="Electronics">Electronics</option>
			                                              	<option <?php if ('Fabrics' == $b['type_of_product']) {?> selected="selected" <?php }?> value="Fabrics">Fabrics</option>
			                                              	...
			                                              	<option <?php if ('Construction Material' == $b['type_of_product']) {?> selected="selected" <?php }?> value="Construction Material">Construction Material</option>
			                                              	<option <?php if ('Hazardous' == $b['type_of_product']) {?> selected="selected" <?php }?> value="Hazardous">Hazardous</option>
			                                              	<option <?php if ('Hazardous and perishable' == $b['type_of_product']) {?> selected="selected" <?php }?> value="Hazardous and perishable">Hazardous and perishable</option>
			                                              	<option <?php if ('Non Hazardous' == $b['type_of_product']) {?> selected="selected" <?php }?> value="Non Hazardous">Non Hazardous</option>
			                                              	<option <?php if ('Non Perishable' == $b['type_of_product']) {?> selected="selected" <?php }?> value="Non Perishable">Non Perishable</option>
			                                              	<option <?php if ('Other' == $b['type_of_product']) {?> selected="selected" <?php }?> value="Other">Other</option>
...
width: 32%;"> 
 ...
 <input type="hidden" name="tabname" id="tabname" value="existing" />
     ...
     <h1>&nbsp;</h1>
		...
		<div class="row">
			...
			<div class="col-md-5" style="border:1px solid gray;padding:3px 10px;background-color:#f4f3f2;width:44%;display:inline-block;float:right">
				<table style="width:100%">
					<tr><td style="width:25%;font-weight:bold"><img src="Invoice_Png_Files/Invoice Date.png" width="160"></td><td style="width:80%;font-weight:bold;font-size:15px !important" align="right">'.$_POST['invoice_date']." ".$time.'</td></tr>
				</table>
			</div>
		</div>
			...
			<div class="col-md-5" style="border:1px solid gray;background-color:#f4f3f2;width:46.5%;display:inline-block;color:#000000;padding-right:0px !important;padding-left:0px !important">
				<table class="table"> 
						...
						<tr>
							...
							<td style="color:#6c6c6c;font-size:10px !important">'.$shipment['sender_name'].'
							</td>
						</tr>
						<tr>
							<td><img src="Invoice_Png_Files/address.png" width="120"></td>
							<td style="color:#6c6c6c;font-size:10px !important">'.$shipment['source_address'].'</td>
						</tr>
						<tr>
							<td style="color:#6c6c6c;font-size:10px !important">&nbsp;Area</td>
							<td style="color:#6c6c6c;font-size:10px !important">'.$shipment['area'].'</td>
						</tr>
						<tr>
							<td><img src="Invoice_Png_Files/cont-no.png" width="120"></td>
							<td style="color:#6c6c6c;font-size:10px !important">'.$shipment['sender_mobile'].'</td>
						</tr>
						<tr>
							<td><img src="Invoice_Png_Files/city.png" width="120"></td>
							<td style="color:#6c6c6c;font-size:10px !important">'.$city['name'].'</td>
						</tr>
						<tr>
							<td><img src="Invoice_Png_Files/country.png" width="120"></td>
							<td style="text-align:left;color:#6c6c6c;font-size:10px !important">Saudi Arabia</td>
						</tr>';
						$html.='<tr>
								<td><img src="Invoice_Png_Files/vat.no.png" width="120"></td>
								<td style="color:#6c6c6c;font-size:10px !important">'.$sender_vat.'</td>
							</tr>';
						$html.='<tr>
								<td style="color:#6c6c6c;font-size:10px !important">&nbsp;IQAMA No.</td>
								<td style="color:#6c6c6c;font-size:10px !important">'.$sender_iqama.'</td>
							</tr>';
						$html.='
